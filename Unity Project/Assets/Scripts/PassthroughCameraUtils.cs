...
namespace Scripts
{
    ...
    public static class PassthroughCameraUtils
    {
        ...
        // Caches
        internal static readonly Dictionary<PassthroughCameraHandler.FrontCameraSelection, (string id, int index)> CameraEyeToCameraIdMap = new();
        private static readonly ConcurrentDictionary<PassthroughCameraHandler.FrontCameraSelection, List<Vector2Int>> s_cameraOutputSizes = new();
        ...
        public static List<Vector2Int> GetOutputSizes(PassthroughCameraHandler.FrontCameraSelection cameraEye)
        {
        ...
        /// </summary>
        /// <param name="cameraEye">The passthrough camera</param>
        public static PassthroughCameraIntrinsics GetCameraIntrinsics(PassthroughCameraHandler.FrontCameraSelection cameraEye)
        {
        ...
        public static string GetCameraIdByEye(PassthroughCameraHandler.FrontCameraSelection cameraEye)
        {
            _ = EnsureInitialized();
        ...
        public static Pose GetCameraPoseInWorld(PassthroughCameraHandler.FrontCameraSelection cameraEye)
        {
            var index = cameraEye == PassthroughCameraHandler.FrontCameraSelection.Left ? 0 : 1;
        ...
        /// </param>
        public static Ray ScreenPointToRayInWorld(PassthroughCameraHandler.FrontCameraSelection cameraEye, Vector2Int screenPoint)
        {
        ...
        /// or <see cref="GetOutputSizes"/> methods.
        /// </param>
        public static Ray ScreenPointToRayInCamera(PassthroughCameraHandler.FrontCameraSelection cameraEye, Vector2Int screenPoint)
        {
            ...
            for (var idIndex = 0; idIndex < cameraIds.Length; idIndex++)
            {
                ...
                switch (cameraPosition)
                {
                    case CameraPosition.Left:
                        ...
                        CameraEyeToCameraIdMap[PassthroughCameraHandler.FrontCameraSelection.Left] = (cameraId, idIndex);
                        break;
                    case CameraPosition.Right:
                        Debug.Log($"PCA: Found right passthrough cameraId = {cameraId}");
                        CameraEyeToCameraIdMap[PassthroughCameraHandler.FrontCameraSelection.Right] = (cameraId, idIndex);
                        break;
                    default:
        ...
        private static List<Vector2Int> GetOutputSizesInternal(PassthroughCameraHandler.FrontCameraSelection cameraEye)
        {
            _ = EnsureInitialized();
        ...
        private static AndroidJavaObject GetCameraCharacteristics(PassthroughCameraHandler.FrontCameraSelection eye)
        {
